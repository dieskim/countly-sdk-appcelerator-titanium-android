...
static void TitaniumCountlyAndroidMessaging_init(Handle<Object> exports)
{
	HandleScope scope;
	...
	exports->Set(String::New("getBinding"), FunctionTemplate::New(TitaniumCountlyAndroidMessaging_getBinding)->GetFunction());
}
	...
	(JNIEnv *env, jobject self)
{
	...
	titanium::KrollBindings::addExternalLookup(&(::TitaniumCountlyAndroidMessagingBindings::lookupGeneratedInit));
}
